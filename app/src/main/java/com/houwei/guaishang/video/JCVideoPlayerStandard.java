...
import com.houwei.guaishang.view.cropimage.RoundAngleImageView;
...
public class JCVideoPlayerStandard extends JCVideoPlayer {
    ...
    public RoundAngleImageView thumbImageView;
    public ImageView coverImageView;

    private boolean hideTimeTextView;
    ...
    protected void init(Context context) {
        ...
        thumbImageView = (RoundAngleImageView) findViewById(R.id.thumb);

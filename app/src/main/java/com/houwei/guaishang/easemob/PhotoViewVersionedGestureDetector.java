...
abstract class PhotoViewVersionedGestureDetector {
	static final String LOG_TAG = "VersionedGestureDetector";
	OnGestureListener mListener;

	public static PhotoViewVersionedGestureDetector newInstance(Context context, OnGestureListener listener) {
		final int sdkVersion = Build.VERSION.SDK_INT;
		PhotoViewVersionedGestureDetector detector = null;
	...
	private static class CupcakeDetector extends PhotoViewVersionedGestureDetector {

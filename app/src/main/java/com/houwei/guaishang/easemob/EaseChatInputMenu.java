...
import com.houwei.guaishang.easemob.EaseChatExtendMenu.EaseChatExtendMenuItemClickListener;
import com.houwei.guaishang.easemob.EaseChatPrimaryMenuBase.EaseChatPrimaryMenuListener;
import com.houwei.guaishang.easemob.EaseEmojiconMenuBase.EaseEmojiconMenuListener;
    ...
    public void init(List<EaseEmojiconGroupEntity> emojiconGroupList) {
        ...
        if(emojiconMenu == null){
            ...
            if(emojiconGroupList == null){
                ...
                emojiconGroupList.add(new EaseEmojiconGroupEntity(R.drawable.expression_1,  activity.getITopicApplication().getFaceManager().getEmojiconList()));
            }
            ...
            public void onExpressionClicked(EaseEmojicon emojicon) {
                if(emojicon.getType() != EaseEmojicon.Type.BIG_EXPRESSION){
                    ...
                    if(emojicon.getEmojiText() != null){
                        ...
                        chatPrimaryMenu.onEmojiconInputEvent(emojicon);
                    }
                }else{
                    if(listener != null){

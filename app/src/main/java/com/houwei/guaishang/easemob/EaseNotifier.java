...
public class EaseNotifier {
    ...
    protected void sendNotification(EMMessage message, boolean isForeground, boolean numIncrease) {
        ...
        try {
        	String notifyText = message.getStringAttribute(HisRootActivity.SENDER_NAME_KEY, "有人") + "：";
...
//            mBuilder.setContentText(summaryBody);
            mBuilder.setContentText(message.getBooleanAttribute("toMain", false)?notifyText:summaryBody);

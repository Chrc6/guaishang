...
public class NumberPickerScroller  {
     ...
     */
    public NumberPickerScroller(Context context) {
        this(context, null);
    }
     ...
     */
    public NumberPickerScroller(Context context, Interpolator interpolator) {
     ...
     */
    public NumberPickerScroller(Context context, Interpolator interpolator, boolean flywheel) {
        mFinished = true;

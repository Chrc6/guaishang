...
public class ParallaxListView extends PagedListView {

    public final static double NO_ZOOM = 1;
    private ArrayList<com.houwei.guaishang.views.ParallaxOnOverScrollByListener> mOnOverScrollByList = new ArrayList<com.houwei.guaishang.views.ParallaxOnOverScrollByListener>();
    private ArrayList<OnTouchEventListener> mOnTouchEventList = new ArrayList<OnTouchEventListener>();
    private ImageView mImageView;
    private int mDrawableMaxHeight = -1;
    private int mImageViewHeight = -1;
  
    private com.houwei.guaishang.views.ParallaxOnOverScrollByListener onScroll = new com.houwei.guaishang.views.ParallaxOnOverScrollByListener() {
        ...
        public boolean overScrollBy(int deltaX, int deltaY, int scrollX,
            ...
            if (mImageView.getHeight() <= mDrawableMaxHeight && isTouchEvent) {
                ...
                if (deltaY < 0) {
                    ...
                    if (mImageView.getHeight() - deltaY / 1.2 >= mImageViewHeight) {

                        mImageView.getLayoutParams().height = (int)(mImageView
                                .getHeight() - deltaY / 1.2 < mDrawableMaxHeight ? mImageView
                                .getHeight() - deltaY / 1.2
                                : mDrawableMaxHeight);
        ...
        public void onTouchEvent(MotionEvent ev) {
            ...
            if (ev.getAction() == MotionEvent.ACTION_UP) {
                ...
                if (mImageViewHeight - 1 < mImageView.getHeight()) {
                    ParallaxBackAnimimation animation = new ParallaxBackAnimimation(mImageView,
    ...
    private void addOnScrolledListener(com.houwei.guaishang.views.ParallaxOnOverScrollByListener onScrolled) {

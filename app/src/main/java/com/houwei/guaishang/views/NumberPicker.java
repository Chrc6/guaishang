...
public class NumberPicker extends LinearLayout {
    ...
    /**
     * The {@link NumberPickerScroller} responsible for flinging the selector.
     */
    private final NumberPickerScroller mFlingScroller;

    /**
     * The {@link NumberPickerScroller} responsible for adjusting the selector.
     */
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mFlingScroller = new NumberPickerScroller(getContext(), null, true);
        mAdjustScroller = new NumberPickerScroller(getContext(), new DecelerateInterpolator(2.5f));
     ...
     */
    private boolean moveToFinalScrollerPosition(NumberPickerScroller scroller) {
    ...
    public void computeScroll() {
        NumberPickerScroller scroller = mFlingScroller;
     ...
     */
    private void onScrollerFinished(NumberPickerScroller scroller) {

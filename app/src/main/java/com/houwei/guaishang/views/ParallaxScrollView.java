...
public class ParallaxScrollView extends ScrollView {
    ...
    private ArrayList<ParallaxOnOverScrollByListener> mOnOverScrollByList = new ArrayList<ParallaxOnOverScrollByListener>();
    private ArrayList<ParallaxOnTouchEventListener> mOnTouchEventList = new ArrayList<ParallaxOnTouchEventListener>();
    private ImageView mImageView;
	private int mDrawableMaxHeight = -1;
	private int mImageViewHeight = -1;
    private ParallaxOnOverScrollByListener onScroll = new ParallaxOnOverScrollByListener() {
    ...
    private ParallaxOnTouchEventListener onTouched = new ParallaxOnTouchEventListener() {
    ...
    private void addOnScrolledListener(ParallaxOnOverScrollByListener onScrolled) {

        mOnOverScrollByList.add(onScrolled);

    }

    private void addOnTouchListener(ParallaxOnTouchEventListener onTouched) {
